export const Map = {
    ...
    init: function() {
        const dom = document.getElementById('graphic-map');
        ...
        this.option = {
            title:{
            text: 'Quantité des articles expédiés dans chaque pays par mois',
            left: 'center',
            top: '5%',
            },
            tooltip: {
            ...
            visualMap: {
            color: ['#732424', '#ff0000','#e0ffff' ], // Cyan très clair, rouge sombre, violet
            calculable: true,
            orient: 'horizontal',
            left: 'center',
            bottom: '2%'
    ...
    updateData: function(newXAxisData, newYAxisData,quantity) {
        ...
        // Mettre à jour les données de xAxis si nécessaire
        
                this.option.xAxis.data = newXAxisData;
                this.option.yAxis.data = newYAxisData;
                this.option.series[0].data = quantity;
